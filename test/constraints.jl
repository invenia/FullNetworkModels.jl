...
function tests_branch_flow_limits(T, fnm::FullNetworkModel, sys_ptdf)
    @testset "All branch constraints were added" begin
        ...
        @test has_constraint(fnm.model, "branch_flow_sl1_max_zero")
        @test has_constraint(fnm.model, "branch_flow_sl2_max_zero")
        @test has_constraint(fnm.model, "branch_flow_sl2_max_one")
        @test has_constraint(fnm.model, "branch_flow_sl1_max_two")
    end
    system = fnm.system
